...
export default function BotonDetallePago({ idPaymentOperation }: Props) {
  ...
  if (!idPaymentOperation) {
    return (
      <span className="text-xs text-slate-500 bg-slate-50 p-2 rounded-lg border border-slate-200 text-center font-medium">
  ...
  return (
    <>
      <button
        ...
        disabled={cargando}
        // Botón principal con texto e ícono negros, y borde oscuro
      ...
      >
        ...
        {cargando ? "Consultando..." : "Detalles del Pago"}
      </button>
